  ...
  return (
    <div className='gpt3__whatgpt3 section__margin ' id="wgpt3">
      ...
      <div className='gpt3__whatgpt3-container'>
        ...
        <Feature title='Education' text='Education" text="At jointure ladyship an insisted so humanity he. Friendly bachelor entrance to on by. As put impossible own apartments ' />
      </div>
    </div>
  )
}
